...
public class WordAdapter extends ArrayAdapter<Word> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //Decides whether the word object stored in the currentWord class has an image or not using an IF statement on the hasImage() method
        //if the hasImage() method is true(image exists),then the imageView variable which has the caught Imageview is set to visible
